...
impl crate::sync::Forgejo {
    ...
    pub fn get_actions_run(&self) -> crate::sync::Request<'_, endpoints::GetActionsRun, ActionRun> {
        endpoints::GetActionsRun {}
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    pub fn get_admin_runners(
        ...
        '_,
        endpoints::GetAdminRunners,
        (ActionRunnerListHeaders, Vec<ActionRunner>),
    > {
        endpoints::GetAdminRunners { query }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    ///
    /// - `body`: See [`RegisterRunnerOptions`]
    pub fn register_admin_runner(
        &self,
        body: RegisterRunnerOptions,
    ) -> crate::sync::Request<'_, endpoints::RegisterAdminRunner, RegisterRunnerResponse> {
        endpoints::RegisterAdminRunner { body: body }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    /// Get action run jobs
    ///
    pub fn admin_get_action_run_jobs(
        &self,
        query: AdminGetActionRunJobsQuery,
    ) -> crate::sync::Request<'_, endpoints::AdminGetActionRunJobs, Vec<ActionRunJob>> {
        endpoints::AdminGetActionRunJobs { query }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    pub fn get_admin_runner(
        &self,
        runner_id: &str,
    ) -> crate::sync::Request<'_, endpoints::GetAdminRunner<'_>, ActionRunner> {
        endpoints::GetAdminRunner { runner_id }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    ///
    /// - `runner_id`: ID of the runner
    pub fn delete_admin_runner(
        &self,
        runner_id: &str,
    ) -> crate::sync::Request<'_, endpoints::DeleteAdminRunner<'_>, ()> {
        endpoints::DeleteAdminRunner { runner_id }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    /// Get a runner registration token for registering global runners
    pub fn admin_get_registration_token(
        &self,
    ) -> crate::sync::Request<'_, endpoints::AdminGetRegistrationToken, RegistrationToken> {
        endpoints::AdminGetRegistrationToken {}
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    ///
    /// - `username`: username of user
    pub fn admin_list_user_access_tokens(
        &self,
        username: &str,
    ) -> crate::sync::Request<
        '_,
        endpoints::AdminListUserAccessTokens<'_>,
        (AccessTokenListHeaders, Vec<AccessToken>),
    > {
        endpoints::AdminListUserAccessTokens { username }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    pub fn admin_create_user_access_token(
        &self,
        username: &str,
        body: CreateAccessTokenOption,
    ) -> crate::sync::Request<'_, endpoints::AdminCreateUserAccessToken<'_>, AccessToken> {
        endpoints::AdminCreateUserAccessToken {
            username,
            body: body,
        }
        .make_request()
    ...
    pub fn admin_delete_user_access_token(
        &self,
        username: &str,
        token: &str,
    ) -> crate::sync::Request<'_, endpoints::AdminDeleteUserAccessToken<'_>, ()> {
        endpoints::AdminDeleteUserAccessToken { username, token }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    pub fn get_org_runners(
        ...
        '_,
        endpoints::GetOrgRunners<'_>,
        (ActionRunnerListHeaders, Vec<ActionRunner>),
    > {
        endpoints::GetOrgRunners { org, query }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    /// - `org`: name of the organization
    /// - `body`: See [`RegisterRunnerOptions`]
    pub fn register_org_runner(
        &self,
        org: &str,
        body: RegisterRunnerOptions,
    ) -> crate::sync::Request<'_, endpoints::RegisterOrgRunner<'_>, RegisterRunnerResponse> {
        endpoints::RegisterOrgRunner { org, body: body }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    /// - `org`: name of the organization
    /// - `runner_id`: ID of the runner
    pub fn get_org_runner(
        &self,
        org: &str,
        runner_id: &str,
    ) -> crate::sync::Request<'_, endpoints::GetOrgRunner<'_>, ActionRunner> {
        endpoints::GetOrgRunner { org, runner_id }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    /// - `org`: name of the organization
    /// - `runner_id`: ID of the runner
    pub fn delete_org_runner(
        &self,
        org: &str,
        runner_id: &str,
    ) -> crate::sync::Request<'_, endpoints::DeleteOrgRunner<'_>, ()> {
        endpoints::DeleteOrgRunner { org, runner_id }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    /// - `owner`: owner of the repo
    /// - `repo`: name of the repo
    pub fn list_action_artifacts(
        &self,
        owner: &str,
        repo: &str,
        query: ListActionArtifactsQuery,
    ) -> crate::sync::Request<'_, endpoints::ListActionArtifacts<'_>, Vec<ActionArtifact>> {
        endpoints::ListActionArtifacts { owner, repo, query }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    pub fn get_action_artifact(
        &self,
        owner: &str,
        repo: &str,
        artifact_id: i64,
    ) -> crate::sync::Request<'_, endpoints::GetActionArtifact<'_>, ActionArtifact> {
        endpoints::GetActionArtifact {
            owner,
            repo,
            artifact_id,
        }
    ...
    /// - `repo`: name of the repo
    /// - `artifact_id`: ID of the artifact
    pub fn delete_action_artifact(
        &self,
        owner: &str,
        repo: &str,
        artifact_id: i64,
    ) -> crate::sync::Request<'_, endpoints::DeleteActionArtifact<'_>, ()> {
        endpoints::DeleteActionArtifact {
            owner,
            repo,
            artifact_id,
        }
    ...
    /// - `repo`: name of the repo
    /// - `artifact_id`: ID of the artifact
    pub fn download_action_artifact(
        &self,
        owner: &str,
        repo: &str,
        artifact_id: i64,
    ) -> crate::sync::Request<'_, endpoints::DownloadActionArtifact<'_>, Bytes> {
        endpoints::DownloadActionArtifact {
            owner,
            repo,
            artifact_id,
        }
    ...
    pub fn repo_get_action_job_logs(
        &self,
        owner: &str,
        repo: &str,
        job_id: i64,
        query: RepoGetActionJobLogsQuery,
    ) -> crate::sync::Request<'_, endpoints::RepoGetActionJobLogs<'_>, String> {
        endpoints::RepoGetActionJobLogs {
            owner,
            repo,
            job_id,
            query,
    ...
    pub fn get_repo_runners(
        ...
        '_,
        endpoints::GetRepoRunners<'_>,
        (ActionRunnerListHeaders, Vec<ActionRunner>),
    > {
        endpoints::GetRepoRunners { owner, repo, query }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    /// - `repo`: name of the repo
    /// - `body`: See [`RegisterRunnerOptions`]
    pub fn register_repo_runner(
        &self,
        owner: &str,
        repo: &str,
        body: RegisterRunnerOptions,
    ) -> crate::sync::Request<'_, endpoints::RegisterRepoRunner<'_>, RegisterRunnerResponse> {
        endpoints::RegisterRepoRunner {
            owner,
            repo,
            body: body,
        }
    ...
    /// - `repo`: name of the repo
    /// - `runner_id`: ID of the runner
    pub fn get_repo_runner(
        &self,
        owner: &str,
        repo: &str,
        runner_id: &str,
    ) -> crate::sync::Request<'_, endpoints::GetRepoRunner<'_>, ActionRunner> {
        endpoints::GetRepoRunner {
            owner,
            repo,
            runner_id,
        }
    ...
    /// - `repo`: name of the repo
    /// - `runner_id`: ID of the runner
    pub fn delete_repo_runner(
        &self,
        owner: &str,
        repo: &str,
        runner_id: &str,
    ) -> crate::sync::Request<'_, endpoints::DeleteRepoRunner<'_>, ()> {
        endpoints::DeleteRepoRunner {
            owner,
            repo,
            runner_id,
        }
    ...
    /// - `repo`: name of the repo
    /// - `run_id`: id of the action run
    pub fn delete_action_run(
        &self,
        owner: &str,
        repo: &str,
        run_id: i64,
    ) -> crate::sync::Request<'_, endpoints::DeleteActionRun<'_>, ()> {
        endpoints::DeleteActionRun {
            owner,
            repo,
            run_id,
        }
    ...
    pub fn list_action_run_artifacts(
        &self,
        owner: &str,
        repo: &str,
        run_id: i64,
        query: ListActionRunArtifactsQuery,
    ) -> crate::sync::Request<'_, endpoints::ListActionRunArtifacts<'_>, Vec<ActionArtifact>> {
        endpoints::ListActionRunArtifacts {
            owner,
            repo,
            run_id,
            query,
    ...
    /// - `repo`: name of the repo
    /// - `run_id`: ID of the workflow run
    pub fn cancel_action_run(
        &self,
        owner: &str,
        repo: &str,
        run_id: i64,
    ) -> crate::sync::Request<'_, endpoints::CancelActionRun<'_>, ()> {
        endpoints::CancelActionRun {
            owner,
            repo,
            run_id,
        }
    ...
    /// - `repo`: name of the repo
    /// - `run_id`: ID of the workflow run
    pub fn list_action_run_jobs(
        &self,
        owner: &str,
        repo: &str,
        run_id: i64,
    ) -> crate::sync::Request<'_, endpoints::ListActionRunJobs<'_>, Vec<ActionRunJob>> {
        endpoints::ListActionRunJobs {
            owner,
            repo,
            run_id,
        }
    ...
    /// - `owner`: owner of the repo
    /// - `repo`: name of the repo
    /// - `run_id`: ID of the workflow run. The ZIP contains the latest attempt of each job in the run, with each entry named `{job-name}-{job-id}-attempt-{N}.log` (the job ID prevents collisions when two jobs share a name; the attempt number records which run the log came from). The run itself has no attempt number — jobs are re-run independently, so use the per-job logs endpoint with `?attempt` to fetch a specific historical attempt of one job.

    pub fn repo_get_action_run_logs(
        &self,
        owner: &str,
        repo: &str,
        run_id: i64,
    ) -> crate::sync::Request<'_, endpoints::RepoGetActionRunLogs<'_>, Bytes> {
        endpoints::RepoGetActionRunLogs {
            owner,
            repo,
            run_id,
        }
    ...
    pub fn list_action_tasks(
        ...
        endpoints::ListActionTasks { owner, repo, query }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    ///
    pub fn get_user_runners(
        &self,
        query: GetUserRunnersQuery,
    ) -> crate::sync::Request<
        '_,
        endpoints::GetUserRunners,
        (ActionRunnerListHeaders, Vec<ActionRunner>),
    > {
        endpoints::GetUserRunners { query }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    ///
    /// - `body`: See [`RegisterRunnerOptions`]
    pub fn register_user_runner(
        &self,
        body: RegisterRunnerOptions,
    ) -> crate::sync::Request<'_, endpoints::RegisterUserRunner, RegisterRunnerResponse> {
        endpoints::RegisterUserRunner { body: body }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    ///
    /// - `runner_id`: ID of the runner
    pub fn get_user_runner(
        &self,
        runner_id: &str,
    ) -> crate::sync::Request<'_, endpoints::GetUserRunner<'_>, ActionRunner> {
        endpoints::GetUserRunner { runner_id }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    ///
    /// - `runner_id`: ID of the runner
    pub fn delete_user_runner(
        &self,
        runner_id: &str,
    ) -> crate::sync::Request<'_, endpoints::DeleteUserRunner<'_>, ()> {
        endpoints::DeleteUserRunner { runner_id }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
    ...
    ///
    /// - `body`: See [`APRemoteFollowOption`]
    pub fn user_current_activity_pub_follow(
        &self,
        body: APRemoteFollowOption,
    ) -> crate::sync::Request<'_, endpoints::UserCurrentActivityPubFollow, ()> {
        endpoints::UserCurrentActivityPubFollow { body: body }
            .make_request()
            .wrap_sync::<_, _>(self)
    }
